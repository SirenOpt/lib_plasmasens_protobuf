...
class ThermalMatrix(_message.Message):
    ...
    thermalDataRow: _containers.RepeatedCompositeFieldContainer[ThermalDataRow]
    def __init__(self, thermalDataRow: _Optional[_Iterable[_Union[ThermalDataRow, _Mapping]]] = ...) -> None: ...
...
class MeasurementRequest(_message.Message):
    ...
    timestamp: float
    protocol_index: int
    def __init__(self, scan_start_time: _Optional[str] = ..., location_index: _Optional[int] = ..., position: _Optional[_Iterable[float]] = ..., spectrometer: _Optional[_Iterable[float]] = ..., voltage_full_wave: _Optional[_Iterable[float]] = ..., current_full_wave: _Optional[_Iterable[float]] = ..., thermal: _Optional[_Union[ThermalMatrix, _Mapping]] = ..., temp: _Optional[float] = ..., pressure: _Optional[float] = ..., humid: _Optional[float] = ..., mfc: _Optional[int] = ..., timestamp: _Optional[float] = ..., protocol_index: _Optional[int] = ...) -> None: ...
